 ...
 *
 * $Id: event.h,v 1.14 2006/02/09 21:21:23 fzago Exp $
 *
 * Program XBLAST
...
typedef enum
{
	...
	XBE_CHAT,					/* Chat key has been entered */
...
typedef enum
{
	XBCE_NONE,					/* no chat event */
	XBCE_START,					/* start chatting */
	XBCE_SEND,					/* send line */
	XBCE_CANCEL,				/* cancel line */
	XBCE_CHANGE,				/* change target */
	XBCE_BACK,					/* backspace a character */
	XBCE_ESCAPE,				/* escape pressed in chat */
	XBCE_ENTER,					/* enter pressed in chat */
	NUM_XBCE
} XBChatEvent;
