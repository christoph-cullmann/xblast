 ...
 *
 * $Id: ini_file.h,v 1.10 2005/01/06 18:28:10 lodott Exp $
 *
 * Program XBLAST
...
extern const DBSection *DB_GetSection (const DBRoot *db, XBAtom atom);
...
extern DBConversionResult DB_ConvertEntryInt   (const DBSection *section, XBAtom atom, int *pValue, const DBToInt *convTable);
extern DBConversionResult DB_ConvertEntryData  (const DBSection *section, XBAtom atom, void **pValue, const DBToData *convTable);
extern DBConversionResult DB_ConvertEntryFlags (const DBSection *section, XBAtom atom, unsigned *pValue, const DBToInt *convTable);
...
extern XBBool DB_LoadDir (DBRoot *db, const char *path, const char *ext, DBType type, XBAtom mtime, XBAtom section, DBLoadDirFunc func);
