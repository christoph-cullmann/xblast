 ...
 *
 * $Id: mi_stat.h,v 1.5 2006/02/09 21:21:24 fzago Exp $
 *
 * Program XBLAST
...
extern XBMenuItem *MenuCreateStatEntry (int x, int y, int w, const XBStatData * stat,
										MIC_button func, void *funcPar);
extern XBMenuItem *MenuCreateStatHeader (int x, int y, int w, const char *title);
extern XBMenuItem *MenuCreateDemoEntry (int x, int y, int w, const CFGDemoEntry * demo,
										MIC_button func, void *funcPar);
extern XBMenuItem *MenuCreateDemoHeader (int x, int y, int w);
extern XBMenuItem *MenuCreateGameEntry (int x, int y, int w, const XBNetworkGame **,
										MIC_button func);
