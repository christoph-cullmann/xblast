 ...
 *
 * $Id: w32_mm.h,v 1.3 2006/02/09 18:31:47 fzago Exp $
 *
 * Program XBLAST
...
WINMMAPI MMRESULT WINAPI timeSetEvent (UINT uDelay, UINT uResolution, LPTIMECALLBACK fptc,
...
extern UINT STDCALL waveOutOpen (HWAVEOUT FAR * lphWaveOut, UINT uDeviceID,
								 const WAVEFORMAT FAR * lpFormat, DWORD dwCallback,
								 DWORD dwInstance, DWORD dwFlags);
extern UINT STDCALL waveOutClose (HWAVEOUT hWaveOut);
extern UINT STDCALL waveOutReset (HWAVEOUT hWaveOut);
extern UINT STDCALL waveOutPrepareHeader (HWAVEOUT hWaveOut, WAVEHDR FAR * lpWaveOutHdr,
										  UINT uSize);
extern UINT STDCALL waveOutUnprepareHeader (HWAVEOUT hWaveOut, WAVEHDR FAR * lpWaveOutHdr,
											UINT uSize);
