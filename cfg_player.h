 ...
 *
 * $Id: cfg_player.h,v 1.10 2006/02/09 21:21:23 fzago Exp $
 *
 * Program XBLAST
...
extern XBBool SendPlayerConfig (CFGType, XBSndQueue * sndQueue, XBTeleCOT cot, XBTeleIOB iob,
...
extern void AppendGameResult (CFGType cfgType, XBAtom fname, XBAtom atom, int k, int *regPl,
							  int *PID, int *Score);

extern void StoreTimePlayerRating (CFGType cfgType, XBAtom atom, int k, int *regPl, int *PID, float *rating);	// XBST
extern void AppendTimePlayerRating (CFGType cfgType, XBAtom fname, XBAtom atom, int k, int *regPl,
