 ...
 *
 * $Id: com_browse.h,v 1.4 2004/10/21 19:28:41 lodott Exp $
 *
 * Program XBLAST 
...
/* receive handler */
typedef void (*BrowseReceiveFunc) (XBCommBrowse *, const XBBrowseTele *tele, const char *, unsigned short);
/* activity handler */
 ...
 * global prototypes
 */
extern XBComm *Browse_CommInit (XBCommBrowse *, XBCommType, XBSocket *, BrowseReceiveFunc, BrowseEventFunc, XBCommFunc);
