 ...
 *
 * $Id: gui.h,v 1.10 2006/02/24 21:57:55 fzago Exp $
 *
 * Program XBLAST
...
typedef enum
{
	...
	KB_CHAT,					/* uses chat keymapping */
	KB_MENU,					/* uses XBlast chat+menu keymapping */
	KB_XBLAST,					/* uses XBlast chat+game keymapping */
...
extern void GUI_ShowCursor(XBBool enable);
