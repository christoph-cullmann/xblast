 ...
 *
 * $Id: com_newgame.h,v 1.8 2006/02/09 21:21:23 fzago Exp $
 *
 * Program XBLAST
 ...
 * global prototypes
 */
extern XBComm *NewGame_CreateComm (const char *deviceAddress, unsigned short port,
								   const char *broadcastAddress, const CFGGameHost * cfg,
								   const CFGGameSetup * setup);
